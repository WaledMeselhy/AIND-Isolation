...
def custom_score(game, player):
    ...
    return 1.5 * float(my_moves * my_moves - opp_moves * opp_moves)
...
def custom_score_2(game, player):
    ...
    return 1.5 * float((my_moves -opp_moves)/ (opp_moves + .000001)) - 1.5 * float((opp_moves -my_moves)/ (my_moves + .000001))
...
def custom_score_3(game, player):
    ...
    my_moves = len(game.get_legal_moves(player))
    if my_location and opp_location:
        return float(abs(sum(my_location) - sum(opp_location))) + my_moves
    elif opp_location:
        return float("-inf")
    else:
        return float("inf")
...
class IsolationPlayer:
    ...
    ********************  DO NOT MODIFY THIS CLASS  ********************
    ...
    Parameters
    ----------
    search_depth : int (optional)float(own_moves - opp_moves)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **************  YOU DO NOT NEED TO MODIFY THIS FUNCTION  *************
        ...
        time_left : callable
            ...
            current turn. Returning with any less than 0 ms refloat maining forfeits
            the game.
    ...
    def minimax(self, game, depth):
        ...
        This should be a modified versionmin_value of MINIMAX-DECISION in the AIMA text.
        ...
        **********************************************************************
        ...
        game : isolation.Board
            ...
            current game statedepth-limited minimax
        ...
        for i in range(0, len(legal_moves)):
            g1 = game.forecast_move(legal_moves[i])
            min_value = self.min_value(g1, depth - 1)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        -------
        (int, int)
            Board coordinates corresponding to a legal move; may returnAlphaBetaPlayer
            (-1, -1) if there are no available legal moves.
        """
        self.time_left = time_left
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        for i in range(0, len(legal_moves)):
            g1 = game.forecast_move(legal_moves[i])
            min_value = self.min_value(g1, depth - 1, alpha, beta)
            if min_value > best_score:
                best_move = legal_moves[i]
                best_score = min_value
            if best_score >= beta:
